...
export default function ScheduleSidebar({
  ...
  return (
    <aside
      className={`border-gray-200 bg-gradient-to-br from-blue-50 via-cyan-50 to-sky-50 flex flex-col gap-3 transition-all duration-300 ease-in-out overflow-hidden ${
        isOpen
          ? 'w-[360px] p-4 border-l opacity-100'
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border border-gray-200 rounded-lg px-3 py-1.5 text-sm text-slate-900 bg-white focus:border-blue-500 focus:outline-none"
        ...
        <button
          onClick={startDemo}
          disabled={status === 'ongoing'}
          className="px-4 py-1.5 rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-all font-semibold text-xs"
          type="button"
        >
          Demo Call
        </button>
